...
let package = Package(
    ...
    targets: [
        ...
        .target(name: "Hub", resources: [.process("FallbackConfigs")], swiftSettings: [.enableExperimentalFeature("StrictConcurrency")]),
        .target(name: "Tokenizers", dependencies: ["Hub"], swiftSettings: [.enableExperimentalFeature("StrictConcurrency")]),
        .target(name: "TensorUtils", swiftSettings: [.enableExperimentalFeature("StrictConcurrency")]),
        .target(name: "Generation", dependencies: ["Tokenizers", "TensorUtils"], swiftSettings: [.enableExperimentalFeature("StrictConcurrency")]),
        .target(name: "Models", dependencies: ["Tokenizers", "Generation", "TensorUtils"], swiftSettings: [.enableExperimentalFeature("StrictConcurrency")]),
